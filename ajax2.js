...
function showWeather(weatherString){
	...
	let ditWeer = 
		...
		'<img src="images/' + weatherObject.liveweer[0].image + '.png">';
...
let weatherObject = JSON.parse(weatherString); // Convert JSON string => Object.
let reclame = ["Reclame", "Deze Reclame is heel mals!!", "<img src='ma.jpg'>  ", "Laatste reclame bericht!"];
	let ditWeer = 
		weatherObject.liveweer[0].plaats+ " -" +

		"<span class=tickWrapper>" +
		"<span class='purple'>T</span>emperatuur | " +
		weatherObject.liveweer[0].temp + " &#176;C" +
		"</span>" +

		//Reclame
		"<span class=tickWrapper>" +
		"<span class='purple'>R</span>eclame | " +
		reclame[0] + 
		"</span>" +		


		"<span class=tickWrapper>" +
		" <span class='purple'>G</span>emiddelde tempratuur | "+
		weatherObject.liveweer[0].gtemp+ 
		"</span>" +
		...
		"<span class=tickWrapper>" +
		" <span class='purple'>B</span>ewolking | "+
		weatherObject.liveweer[0].samenv+ 
		"</span>" +
		...
		"<span class=tickWrapper>" +
		" <span class='purple'>W</span>indkracht | "+
		weatherObject.liveweer[0].windk+ 
		"</span>" +
